...
// const Back = ()=> { navigation.goBack()}
    ...
    return (
        ...
        <View style={styles.name}>
            <Text style={styles.textName}>OTH-NIEL</Text>
            <Caption style={styles.captionOne}>Livreur SALARIE</Caption>
        </View>
      </View>
        <View style={styles.row}>
            <View>
                <Badge size={30} style={styles.chiffre} >6</Badge>
        ...
        <View style={styles.info}>
            <View style={styles.position}>
                ...
                <Text style={styles.textSize}> <Text style={styles.grastext}>Téléphone</Text>  : 68060990 </Text>  
            </View>
            <View style={styles.positionOne}>
        
                <Text style={styles.textSize}> <Text style={styles.grastext}>Email</Text>  : kouassicharlesothniel@gmail... </Text>  
            </View>  
            <View style={styles.positionOne}>
        ...
        <Provider>
              <Portal>
              <FAB.Group
                fabStyle={{backgroundColor:'orange', marginBottom: 100}}
                open={open}
                icon={open ? 'lock' : 'plus'}
                actions={[
                  {
